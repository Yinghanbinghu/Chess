...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    ...
    public void removePassPawn(ChessComponent passPawn){     //调用clickController移除过路卒
     ...
     */
    public abstract boolean canMoveTo(ChessComponent[][] chessboard, ChessboardPoint destination,int step);
