 ...
 * 这个类表示国际象棋里面的后
 */
public class WebQueenChessComponent extends WebChessComponent {
    /**
    ...
    public WebQueenChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, WebClickController listener, int size) {
        super(chessboardPoint, location, color, listener, size);
        initiateQueenImage(color);
        if(this.getChessColor()==ChessColor.WHITE) super.setChessName("q");
        else super.setChessName("Q");
    }
