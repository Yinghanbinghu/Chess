 ...
 * 这个类表示国际象棋里面的车
 */
public class WebRookChessComponent extends WebChessComponent {
    /**
    ...
    public WebRookChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, WebClickController listener, int size) {
