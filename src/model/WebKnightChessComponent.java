 ...
 * 这个类表示国际象棋里面的马
 */
public class WebKnightChessComponent extends WebChessComponent {
    /**
    ...
    public WebKnightChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, WebClickController listener, int size) {
