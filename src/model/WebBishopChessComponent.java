 ...
 * 这个类表示国际象棋里面的象
 */
public class WebBishopChessComponent extends WebChessComponent {
    ...
    public WebBishopChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor color, WebClickController listener, int size) {
